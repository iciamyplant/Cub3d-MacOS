...
void	ft_calculs(t_recup *recup, int i)
{
	...
	//printf("recup->s.spriteHeight = %d pour i = %d\n", recup->s.spriteHeight, i);
	...
	//printf("\nrecup->s.spriteWidth = %d\n", recup->s.spriteWidth);
	//printf("\nrecup->s.spriteScreenX = %d\n", recup->s.spriteScreenX);
